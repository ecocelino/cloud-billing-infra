...
import AnomalyWidget from '../shared/AnomalyWidget';
...
const GcpDashboard = () => {
    ...
    useEffect(() => {
        const fetchForecast = async () => {
            ...
            if (selectedProjects.length === 0) {
                url = `/api/forecasting/all/${selectedYear}`;
            } 
                ...
                url = `/api/forecasting/project/${project.project_id}/${selectedYear}`;
            }
    ...
    }, [selectedProjects, selectedYear, token, inventory, selectedPlatform]);
