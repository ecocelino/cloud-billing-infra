                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700" style={{ tableLayout: 'fixed' }}>
                        ...
                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700 text-base">
                            {projectsToDisplay.map((project) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap font-medium text-base">
                                        <Link to={`/project/${project.project_id}`} className="text-blue-600 dark:text-blue-400 hover:underline" onClick={(e) => e.stopPropagation()}>
                            ...
                            <tr className="bg-gray-100 dark:bg-gray-700 font-bold">
                                <td colSpan={6} className="px-6 py-4 text-right text-gray-800 dark:text-gray-100 text-lg">Grand Total</td>
                                <td className="px-6 py-4 text-green-800 dark:text-green-300 font-extrabold text-lg" style={{ width: '20%' }}>{formatCurrency(grandTotalToDisplay)}</td>
...
export default GcpProjectsView;
