...
import { Cloud, LayoutDashboard, FolderOpen, BarChart3, LogOut, Settings, Filter, Tag, ChevronDown, ChevronsLeft, ChevronsRight, FileText, Users, FileCog, Palette, User as ProfileIcon } from 'lucide-react';
...
import { UsersView, BusinessRulesView, CustomizeView } from './components/SettingsView';
            ...
            <div className="flex min-h-screen bg-slate-100 dark:bg-gray-900 font-sans">
                ...
                <div className="main-content-area flex-1 p-4 sm:p-8 overflow-y-auto relative z-0">
                    <Routes>
                        ...
                        <Route path="/settings/business-rules" element={<ProtectedRoute path="/settings/business-rules" element={<BusinessRulesView />} />} />
    ...
    return (
        <Routes>
            <Route 
                path="/login" 
                element={
                    isLoggedIn ? <Navigate to="/dashboard" replace /> : <LoginPage onLogin={login} error={authError} />
                } 
            />
            <Route 
                path="/forgot-password" 
                element={
                    isLoggedIn ? <Navigate to="/dashboard" replace /> : <ForgotPasswordView />
                } 
            />
            <Route 
                path="/*" 
